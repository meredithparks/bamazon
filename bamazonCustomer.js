...
var confirmItem = function (product, object) {
  inquirer
    .prompt({
      ...
      type: "confirm",
      message:
        `You chose` + chalk.blue.bold(` '${product}'. `) + `Is this correct?`,
    })
    .then((answer) => {
    ...
    .prompt({
      ...
      validate: (value) => {
        if (!isNaN(value) && value > 0) {
          ...
          console.log(
            chalk.red(" => Oops, please enter a number greater than 0")
          );
          return false;
        }
      },
          ...
          if (res[0].stock_quantity < answer.howMany) {
            ...
            connection.query(
              ...
              [
                {
                  ...
                  product_sales:
                    chosenItem.product_sales +
                    chosenItem.price * answer.howMany,
                },
                {
                  item_id: chosenItem.item_id,
                },
              ...
              (err, res) => {
                console.log(
                  chalk.blue.bold(
                    `\n\tOrder confirmed!!! Your total was $${(
                      chosenItem.price * chosenItem.howMany
                    ).toFixed(2)}.\n`
                  )
                );
